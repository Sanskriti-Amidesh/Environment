...
climate.onclick = () => {
    ...
    document.getElementById("save").innerHTML = "Do your bit! Save trees, use renewable energy resources and prefer travelling green."
...
consumption.onclick = () => {
    ...
    document.getElementById("save").innerHTML = "Do your bit! Shop for necessary items, don't over-eat and always save your left overs."
...
people.onclick = () => {
    ...
    document.getElementById("save").innerHTML = "Do your bit! Never waste food. Instead, offer it to people or animals who are in need."
    climate.style.backgroundColor = "transparent"
    consumption.style.backgroundColor = "transparent"
    resources.style.backgroundColor = "transparent"
